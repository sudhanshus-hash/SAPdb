# SAPdb: A Database of Short Peptides and Self-Assembled Nanostructures
...
**Web Server:** [https://webs.iiitd.edu.in/raghava/sapdb/](https://webs.iiitd.edu.in/raghava/sapdb/)

## Citation

Mathur, D., Kaur, H., Dhall, A., Sharma, N., & Raghava, G. P. S. (2021). 
...
1.  **Peptide Information:** Core data including amino acid sequence and chemical modifications.
2.  **Assembly Conditions:** Detailed documentation of the environment (pH, solvent) that triggers self-assembly.
3.  **Morphology:** Classification of the resulting nanomaterial, from 1D fibers to 3D hydrogels.
...
© 2021 Elsevier Ltd. All rights reserved. (Refer to the publisher for text and data mining permissions).
